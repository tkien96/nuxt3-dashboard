...
<template>
  <UiDashboardPanelContent class="p-0 pb-24 divide-y divide-gray-200 dark:divide-gray-800">
    <UiDashboardSection v-for="(section, index) in sections" :key="index" :title="section.title"
